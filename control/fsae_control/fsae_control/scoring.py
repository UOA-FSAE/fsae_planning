...
fsae_MPCTest/sim/scoring.py first and then re-copied across — otherwise live
and offline scores stop being comparable, which defeats the entire point of
the file.
...
class RolloutMetrics:
    ...
    def add_step(self, e_y, e_psi, r, u_opt, v_target, v_actual, u_max_steer,
        ...
        solver_failed : bool  True if the controller's solve failed this step
            (always False for a solver-free controller like Stanley).
