...
class StanleyControllerNode(Node):
    def __init__(self):
        ...
        self.declare_parameters(
            ...
            parameters=[
                ...
                ('map_path', ''),     # '' -> live curvature_speed() (default);
                                       ...
                                       # CSV of a precomputed speed profile to use instead.
        ...
        # Static precomputed path, loaded once at startup if path_map_path is set.
        ...
        # Drives close()'s progress/reached_end/time_bonus.
        ...
        # Static path never goes stale (no topic to lose).
